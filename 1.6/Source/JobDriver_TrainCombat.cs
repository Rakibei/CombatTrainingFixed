...
namespace KriilMod_CD
{
    public class JobDriver_TrainCombat : JobDriver
    {
        ...
        protected override IEnumerable<Toil> MakeNewToils()
        {
            ...
            Toil gotoInteractionCell = Toils_Goto.GotoThing(TargetIndex.A, PathEndMode.InteractionCell).EndOnDespawnedOrNull(TargetIndex.A);
            ...
            yield return Toils_Jump.JumpIfTargetNotHittable(TargetIndex.A, gotoInteractionCell);
